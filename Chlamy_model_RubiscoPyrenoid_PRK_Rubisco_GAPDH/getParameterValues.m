...
for SAMPLE = idx
    ...
    for i=1:size(M,1)
        ...
        if strcmp(cond,'lowCO2')
            ...
            elseif i==4 
                x_lb(M{i}) = log(str2double(ExpDataConcentrations{idx_c,i})*0.5);
            elseif i==15
                x_lb(M{i}) = log(str2double(ExpDataConcentrations{idx_c,i})*0.33);
            end
        else
            if i==5 || i==7 || i==8 || i==10 || i==11 || i==12 || i==13 || i==14
                x_lb(M{i}) = log(str2double(ExpDataConcentrations{idx_c,i})*0.99);
            elseif i==6
    ...
    x_lb([71:72 75 82:109 111:114 117:128]) = log(1e-50*ones(length([71:72 75 82:109 111:114 117:128]),1));
    x_ub([71:72 75 82:109 111:114 117:128]) = log(1e-50*ones(length([71:72 75 82:109 111:114 117:128]),1)); % pyrenoid metabolites
